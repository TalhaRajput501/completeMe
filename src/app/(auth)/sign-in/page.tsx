            ...
            <div className='relative z-10 w-full max-w-md'>
              ...
              <form onSubmit={handleSubmit} className='space-y-4'>
                ...
                <Button
                  disabled={loading}
                  type='submit'
                  className={`w-full bg-slate-800 hover:bg-slate-900 text-white font-semibold py-3.5 rounded-lg transition-all duration-200 shadow-lg hover:shadow-xl transform hover:-translate-y-0.5 ${loading ? 'cursor-not-allowed opacity-80' : 'cursor-pointer'}`}
                >
                  {loading ? (
