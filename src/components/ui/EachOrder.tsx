          ...
          <div className="bg-white rounded-lg p-4 border border-slate-200">
            ...
            <div className="space-y-3">
              {order.products.map((item, index) => (
                <div key={`${String(item.productId)}-${index}`} className="flex items-center gap-4 p-3 bg-slate-50 rounded-lg">
                  {productImages[index] && (
                    <img
                  ...
                  <div className="flex-1">
                    <h5 className="font-medium text-slate-800">{`Product ${index + 1}`}</h5>
